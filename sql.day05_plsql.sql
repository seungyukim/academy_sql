...
END sp_maxim;
/
--- 2) Oracle SQL Develper ==> ctrl + enter key 입력으로 컴파일 진행
...
IS
    -- 지역변수 선언 블록, BEDIN ~ END 사이에서 사용되는 변수 선언부
    -- 변수타입 선언시 크기까지 지정
